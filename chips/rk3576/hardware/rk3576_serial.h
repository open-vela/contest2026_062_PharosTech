...
#define RK3576_UART_IER_ERBFI       (1 << 0)  /* Enable Received Data Available Interrupt */
#define RK3576_UART_IER_ETBEI       (1 << 1)  /* Enable Transmit Holding Register Empty Interrupt */
...
#  define RK3576_UART_IIR_IID_NONE       (1  << RK3576_UART_IIR_IID_SHIFT) /* No interrupt pending */
#  define RK3576_UART_IIR_IID_TXEMPTY    (2  << RK3576_UART_IIR_IID_SHIFT) /* THR empty */
#  define RK3576_UART_IIR_IID_RECV       (4  << RK3576_UART_IIR_IID_SHIFT) /* Received data available */
#  define RK3576_UART_IIR_IID_LINESTATUS (6  << RK3576_UART_IIR_IID_SHIFT) /* Receiver line status */
...
#  define RK3576_UART_FCR_TFT_EMPTY      (0 << RK3576_UART_FCR_TFT_SHIFT) /* FIFO empty */
#  define RK3576_UART_FCR_TFT_TWO        (1 << RK3576_UART_FCR_TFT_SHIFT) /* 2 chars in FIFO */
#  define RK3576_UART_FCR_TFT_QUARTER    (2 << RK3576_UART_FCR_TFT_SHIFT) /* FIFO 1/4 full */
#  define RK3576_UART_FCR_TFT_HALF       (3 << RK3576_UART_FCR_TFT_SHIFT) /* FIFO 1/2 full */

#define RK3576_UART_FCR_RT_SHIFT         6           /* RCVR Trigger */
#define RK3576_UART_FCR_RT_MASK          (3 << RK3576_UART_FCR_RT_SHIFT)
#  define RK3576_UART_FCR_RT_ONE         (0 << RK3576_UART_FCR_RT_SHIFT) /* 1 char in FIFO */
#  define RK3576_UART_FCR_RT_QUARTER     (1 << RK3576_UART_FCR_RT_SHIFT) /* FIFO 1/4 full */
#  define RK3576_UART_FCR_RT_HALF        (2 << RK3576_UART_FCR_RT_SHIFT) /* FIFO 1/2 full */
#  define RK3576_UART_FCR_RT_MINUS2      (3 << RK3576_UART_FCR_RT_SHIFT) /* FIFO-2 less than full */

/* LCR – Line Control Register ********************************************/

#define RK3576_UART_LCR_DLS_SHIFT        0
#define RK3576_UART_LCR_DLS_MASK         (3 << RK3576_UART_LCR_DLS_SHIFT)
#  define RK3576_UART_LCR_DLS_5BITS      (0 << RK3576_UART_LCR_DLS_SHIFT) /* 5 bits */
#  define RK3576_UART_LCR_DLS_6BITS      (1 << RK3576_UART_LCR_DLS_SHIFT) /* 6 bits */
#  define RK3576_UART_LCR_DLS_7BITS      (2 << RK3576_UART_LCR_DLS_SHIFT) /* 7 bits */
#  define RK3576_UART_LCR_DLS_8BITS      (3 << RK3576_UART_LCR_DLS_SHIFT) /* 8 bits */
